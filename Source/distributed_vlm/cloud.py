...
def parameter_process():
    ...
    return device, args.weights, args.host, args.port
...
def load_model(model_weights, device):
    ...
    return model, tokenizer, token_emb, lm_head


def reconstruct_from_request():
    raw = request.data
...
if __name__ == "__main__":
    device, model_weights, host, port = parameter_process()
    model, tokenizer, token_emb, lm_head = load_model(model_weights, device)
